...
st.set_page_config(page_title="Report Generator | ESG Pilot", page_icon="📄", layout="wide")
inject_global_css()
pwc_header()
sidebar_auth_widget()
...
"""
    ...
    report_html += '<div class="footer">Generated by ESG Pilot — Autonomous ESG Intelligence Platform</div></body></html>'
